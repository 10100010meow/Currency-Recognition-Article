...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=.52\textwidth]{system-overview}
...
\begin{figure}
	\centering
	\includegraphics[width=0.37\textwidth]{notes-masks/currency-db-shapes}
